...
On-site or remote, these are projects and the role I played. Please email me at [chance@sodiumhalogen.com](mailto:chance@sodiumhalogen.com) for us to collaborate on your project.

<div class="project-item">
  <div class="project-content">
    <h3 class="project-title"><a href="http://savewithenvie.com">Envie | TeamWALT, a Southern Bank Initiative</a></h3>
...
<div class="project-item">
  <div class="project-content">
    <h3 class="project-title"><a href="https://youtu.be/-KbIMCVYA9U">FunFact</a></h3>
    <p class="project-meta">2019 | mobile-app | developer</p>
...
<div class="project-item">
  <div class="project-content">
    <h3 class="project-title"><a href="https://www.gokmusa.org/">Kontakt Mission USA</a></h3>
    <p class="project-meta">2016 | website | developer</p>
    <p class="project-description">A WordPress theme from scratch plus customizations for a non-profit organization to help Germany.</p>
  </div>
</div>
