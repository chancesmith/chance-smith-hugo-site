...
- what gives web pages the ability to interact

## The Workshop

Hi, I'm Chance Smith! In this workshop, I'll help you build a foundation in JavaScript. We will start out with common parts in JavaScript, build up to variables and functions, and finally use GitHub Pages to put your code on the web. Please email me at [chance@sodiumhalogen.com](mailto:chance@sodiumhalogen.com) if you have questions at all.
